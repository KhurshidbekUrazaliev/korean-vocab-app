...
function App({ darkMode }) {
  const vocabulary = [
    { korean: '늦잠', english: 'oversleeping, sleeping in', romanization: 'neutjam' },
    { korean: '대표', english: 'representative, president', romanization: 'daepyo' },
    { korean: '발표', english: 'presentation, announcement', romanization: 'balpyo' },
    { korean: '평가', english: 'evaluation, assessment', romanization: 'pyeongga' },
    { korean: '면접', english: 'interview', romanization: 'myeonjeop' },
    { korean: '지각하다', english: 'to be late, to perceive', romanization: 'jigakhada' },
    { korean: '인생', english: 'life', romanization: 'insaeng' },
    { korean: '방해하다', english: 'to disturb, to interfere', romanization: 'banghaehada' },
    { korean: '버릇', english: 'habit, manners', romanization: 'beoreut' },
    { korean: '해결하다', english: 'to solve, to resolve', romanization: 'haegyeolhada' }
  ];
  ...
  // Styling based on darkMode and the user's chosen red/orange theme
  ...
  // Custom theme colors (Red primary, Orange secondary)
  const primaryAccent = darkMode ? 'text-red-400' : 'text-red-600';
  const secondaryAccent = darkMode ? 'text-orange-400' : 'text-orange-600';
  const buttonGradient = darkMode ? 'from-red-700 to-orange-700' : 'from-red-500 to-orange-500';
  const buttonHoverGradient = darkMode ? 'hover:from-red-600 hover:to-orange-600' : 'hover:from-red-400 hover:to-orange-400';
  const primaryHoverBg = darkMode ? 'hover:bg-gray-700' : 'hover:bg-red-50';
    ...
    return (
      <div className={`min-h-screen ${bgClass} p-8 flex items-center justify-center`}>
        <div className="max-w-2xl w-full text-center">
          <h1 className="text-6xl font-bold text-white mb-4 drop-shadow-lg">Day 09</h1>
          ...
          <div className="grid gap-6 mt-12">
            <button
              ...
              className={`${cardBg} ${primaryHoverBg} ${primaryAccent} font-bold py-8 px-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-4`}
            >
            ...
            <button
              onClick={startQuiz}
              className={`${cardBg} ${primaryHoverBg} ${secondaryAccent} font-bold py-8 px-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-4`}
            >
      ...
      <div className={`min-h-screen ${bgClass} p-8`}>
        <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center w-full">
              ...
              <div className="flex flex-col items-center justify-center mb-8">
                ...
                <button
                  ...
                  className={`mt-4 p-3 rounded-full ${darkMode ? 'bg-gray-700 text-red-300 hover:bg-gray-600' : 'bg-gray-100 text-red-600 hover:bg-gray-200'} transition-colors shadow-md`}
          ...
          <div className="mt-8 flex justify-center">
            <button
              onClick={nextCard}
              className={`${cardBg} ${primaryHoverBg} ${primaryAccent} font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
            >
          ...
          <div className={`${cardBg} rounded-3xl shadow-2xl p-12`}>
            <div className="text-center mb-8">
              ...
              <div className="flex items-center justify-center gap-4">
                  ...
                  <button
                      ...
                      className={`p-2 rounded-full ${darkMode ? 'bg-gray-700 text-red-300 hover:bg-gray-600' : 'bg-gray-100 text-red-600 hover:bg-gray-200'} transition-colors shadow-md`}
                      aria-label={`Listen to ${currentWord.korean}`}
                  >
            ...
            {answered && (
              <div className="mt-8 flex justify-center">
                <button
                  onClick={nextCard}
                  className={`bg-gradient-to-r ${buttonGradient} ${buttonHoverGradient} text-white font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
                >
        ...
        <div className={`${cardBg} max-w-2xl w-full rounded-3xl shadow-2xl p-12 text-center`}>
          ...
          <div className="mb-8">
            <div className={`${darkMode ? 'bg-gray-700' : 'bg-gray-200'} rounded-full h-6 overflow-hidden`}>
              <div className="bg-gradient-to-r from-red-400 to-orange-500 h-full rounded-full transition-all duration-1000" style={{ width: `${percentage}%` }} />
            </div>
          </div>
          <div className="grid gap-4">
              <button

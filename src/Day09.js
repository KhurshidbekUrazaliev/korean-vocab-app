...
function Day09({ darkMode }) {
  const vocabulary = [
    ...
    { korean: '평가', english: 'evaluation, assessment', romanization: 'pyeonggа' },
        ...
        <div className="max-w-2xl w-full text-center">
          ...
          <div className="grid gap-6 mt-12">
            <button
              ...
              className={`${cardBg} hover:bg-yellow-50 ${darkMode ? 'hover:bg-gray-700' : ''} text-red-600 ${darkMode ? 'text-red-400' : ''} font-bold py-8 px-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-4`}
            >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`${cardBg} rounded-3xl shadow-2xl p-12 min-h-96 flex flex-col items-center justify-center cursor-pointer transform hover:scale-102 transition-all`}
            ...
            <div className="text-center w-full">
              <div className={`text-8xl font-bold ${darkMode ? 'text-red-400' : 'text-red-600'} mb-8`}>
                {currentWord.korean}
              </div>
              {showAnswer ? (
          ...
          <div className="mt-8 flex justify-center">
            <button
              onClick={nextCard}
              className={`${cardBg} hover:bg-yellow-50 ${darkMode ? 'hover:bg-gray-700 text-red-400' : 'text-red-600'} font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
            >
          ...
          <div className={`${cardBg} rounded-3xl shadow-2xl p-12`}>
            ...
            {answered && (
              <div className="mt-8 flex justify-center">
                <button
                  onClick={nextCard}
                  className={`bg-gradient-to-r ${darkMode ? 'from-red-700 to-orange-700' : 'from-red-500 to-orange-500'} hover:from-red-600 hover:to-orange-600 text-white font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
                >
    ...
    return (
      <div className={`min-h-screen ${bgClass} p-8 flex items-center justify-center`}>
        <div className={`${cardBg} max-w-2xl w-full rounded-3xl shadow-2xl p-12 text-center`}>
          ...
          <div className={`text-7xl font-bold ${darkMode ? 'text-red-400' : 'text-red-600'} mb-4`}>

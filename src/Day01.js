...
function Day01({ darkMode }) {
  const vocabulary = [
    ...
    { korean: '선약', english: 'prior engagement', romanization: 'seonyak' },
    { korean: '취소하다', english: 'to cancel', romanization: 'chwisohada' },
    { korean: '흡족하다', english: 'to be satisfied', romanization: 'heupjokhada' }
  ];
  ...
  // Function to handle Text-to-Speech with better voice selection
  ...
  const bgClass = darkMode
    ? "bg-gradient-to-br from-gray-900 via-violet-900 to-gray-800"
    ...
    return (
      <div className={`min-h-screen ${bgClass} p-8 flex items-center justify-center`}>
        <div className="max-w-2xl w-full text-center">
          <h1 className="text-6xl font-bold text-white mb-4 drop-shadow-lg">Day 01</h1>
          ...
          <div className="grid gap-6 mt-12">
            <button
              ...
              className={`${cardBg} hover:bg-yellow-50 ${darkMode ? 'hover:bg-gray-700' : ''} text-violet-600 ${darkMode ? 'text-violet-400' : ''} font-bold py-8 px-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-4`}
            >
            ...
            <button
              onClick={startQuiz}
              className={`${cardBg} hover:bg-purple-50 ${darkMode ? 'hover:bg-gray-700' : ''} text-fuchsia-600 ${darkMode ? 'text-fuchsia-400' : ''} font-bold py-8 px-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-4`}
            >
      ...
      <div className={`min-h-screen ${bgClass} p-8`}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`${cardBg} rounded-3xl shadow-2xl p-12 min-h-96 flex flex-col items-center justify-center cursor-pointer transform hover:scale-102 transition-all`}
            ...
            <div className="text-center w-full">
              ...
              <div className="flex flex-col items-center justify-center mb-8">
                <div className={`text-8xl font-bold ${darkMode ? 'text-violet-400' : 'text-violet-600'}`}>
                  {currentWord.korean}
                </div>
                <button
                  onClick={(e) => {
                  ...
                  className={`mt-4 p-3 rounded-full ${darkMode ? 'bg-gray-700 text-violet-300 hover:bg-gray-600' : 'bg-gray-100 text-violet-600 hover:bg-gray-200'} transition-colors shadow-md`}
          ...
          <div className="mt-8 flex justify-center">
            <button
              onClick={nextCard}
              className={`${cardBg} hover:bg-yellow-50 ${darkMode ? 'hover:bg-gray-700 text-violet-400' : 'text-violet-600'} font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
            >
          ...
          <div className={`${cardBg} rounded-3xl shadow-2xl p-12`}>
            <div className="text-center mb-8">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <button
                    ...
                    className={`p-2 rounded-full ${darkMode ? 'bg-gray-700 text-violet-300 hover:bg-gray-600' : 'bg-gray-100 text-violet-600 hover:bg-gray-200'} transition-colors shadow-md`}
                    aria-label={`Listen to ${currentWord.korean}`}
                >
            ...
            {answered && (
              <div className="mt-8 flex justify-center">
                <button
                  onClick={nextCard}
                  className={`bg-gradient-to-r ${darkMode ? 'from-violet-700 to-fuchsia-700' : 'from-violet-500 to-fuchsia-500'} hover:from-violet-600 hover:to-fuchsia-600 text-white font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
                >
    ...
    return (
      <div className={`min-h-screen ${bgClass} p-8 flex items-center justify-center`}>
        <div className={`${cardBg} max-w-2xl w-full rounded-3xl shadow-2xl p-12 text-center`}>
          ...
          <div className={`text-7xl font-bold ${darkMode ? 'text-violet-400' : 'text-violet-600'} mb-4`}>
          ...
          <div className="mb-8">
            <div className={`${darkMode ? 'bg-gray-700' : 'bg-gray-200'} rounded-full h-6 overflow-hidden`}>
              <div className="bg-gradient-to-r from-violet-400 to-fuchsia-500 h-full rounded-full transition-all duration-1000" style={{ width: `${percentage}%` }} />
            </div>
          </div>
          <button
            onClick={startQuiz}

        ...
        <div className="max-w-2xl w-full text-center">
          ...
          <div className="grid gap-6 mt-12">
            <button
              ...
              className={`${cardBg} hover:bg-yellow-50 ${darkMode ? 'hover:bg-gray-700' : ''} text-rose-600 ${darkMode ? 'text-rose-400' : ''} font-bold py-8 px-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-4`}
            >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`${cardBg} rounded-3xl shadow-2xl p-12 min-h-96 flex flex-col items-center justify-center cursor-pointer transform hover:scale-102 transition-all`}
            ...
            <div className="text-center w-full">
              <div className={`text-8xl font-bold ${darkMode ? 'text-rose-400' : 'text-rose-600'} mb-8`}>
                {currentWord.korean}
              </div>
              {showAnswer ? (
          ...
          <div className="mt-8 flex justify-center">
            <button
              onClick={nextCard}
              className={`${cardBg} hover:bg-yellow-50 ${darkMode ? 'hover:bg-gray-700 text-rose-400' : 'text-rose-600'} font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
            >
    ...
    return (
      <div className={`min-h-screen ${bgClass} p-8 flex items-center justify-center`}>
        <div className={`${cardBg} max-w-2xl w-full rounded-3xl shadow-2xl p-12 text-center`}>
          ...
          <div className={`text-7xl font-bold ${darkMode ? 'text-rose-400' : 'text-rose-600'} mb-4`}>

...
function Day04({ darkMode }) {
  ...
  const bgClass = darkMode
    ...
    : "bg-gradient-to-br from-pink-500 via-rose-500 to-fuchsia-400";
        ...
        <div className="max-w-2xl w-full text-center">
          ...
          <div className="grid gap-6 mt-12">
            <button
              ...
              className={`${cardBg} hover:bg-yellow-50 ${darkMode ? 'hover:bg-gray-700' : ''} text-pink-600 font-bold py-8 px-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-4`}
            >
            ...
            <button
              onClick={startQuiz}
              className={`${cardBg} hover:bg-green-50 ${darkMode ? 'hover:bg-gray-700' : ''} text-rose-600 font-bold py-8 px-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-4`}
            >
      ...
      <div className={`min-h-screen ${bgClass} p-8`}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 flex justify-center">
            <button
              onClick={nextCard}
              className={`${cardBg} hover:bg-yellow-50 ${darkMode ? 'hover:bg-gray-700' : ''} text-pink-600 font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
            >
          ...
          <div className={`${cardBg} rounded-3xl shadow-2xl p-12`}>
            ...
            {answered && (
              <div className="mt-8 flex justify-center">
                <button
                  onClick={nextCard}
                  className={`bg-gradient-to-r ${darkMode ? 'from-pink-700 to-rose-700' : 'from-pink-500 to-rose-500'} hover:from-pink-600 hover:to-rose-600 text-white font-bold py-4 px-12 rounded-full shadow-lg transform hover:scale-105 transition-all text-xl`}
                >
    ...
    return (
      <div className={`min-h-screen ${bgClass} p-8 flex items-center justify-center`}>
        <div className={`${cardBg} max-w-2xl w-full rounded-3xl shadow-2xl p-12 text-center`}>
          ...
          <div className={`text-7xl font-bold ${darkMode ? 'text-pink-400' : 'text-pink-600'} mb-4`}>
